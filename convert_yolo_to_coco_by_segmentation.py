...
prefixs = ['/home/a2mind/Data/Ikksu/20230525~20230526/cam1_ccd/']
...
for prefix in prefixs:
    ...
    json_file = os.path.join(json_path, 'segmentation_result.json')
    ...
    for idx, img_path in enumerate(image_list):
        ...
        if not os.path.exists(lbl_path):
            ...
            for line in open(lbl_path, 'r'):
                ...
                segmentations = det[5:]
                seg_list = list()
                for idx_seg, seg in enumerate(segmentations):
                    value = float(seg)
                    if idx_seg % 2 == 0:    # x
                        value *= width
                    else:               # y
                ...
                part_annotations['segmentation'] = [seg_list]
